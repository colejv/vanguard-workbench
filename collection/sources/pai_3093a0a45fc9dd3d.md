# GitHub - NVIDIA/ngc-container-replicator: NGC Container Replicator · GitHub

<!-- source: https://github.com/NVIDIA/ngc-container-replicator -->
...
Rook block storage to provide a persistent volume to hold the
